...
namespace NewResume.Controllers
{
    public class SkillsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SkillId,Duration,Proficiency,SkillName")] Skill skill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SkillId,Duration,Proficiency,SkillName")] Skill skill)
        {
            if (id != skill.SkillId)
            {
                return NotFound();
