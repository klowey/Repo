...
namespace NewResume.Controllers
{
    public class EducationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EducationId,Degree,GraduationDate,SchoolName")] Education education)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EducationId,Degree,GraduationDate,SchoolName")] Education education)
        {
