...
namespace NewResume.Data.Migrations
{
    ...
    [Migration("20170311201521_workhistory")]
    partial class workhistory
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("NewResume.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("NewResume.Models.ContactInfo", b =>
                {
            ...
            modelBuilder.Entity("NewResume.Models.Employer", b =>
                {
                    ...
                    b.Property<int?>("WorkHistoryJobId");

                    b.HasKey("EmployerId");

                    b.HasIndex("WorkHistoryJobId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NewResume.Models.ApplicationUser")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("NewResume.Models.Employer", b =>
                {
                    b.HasOne("NewResume.Models.Job", "WorkHistory")
                        .WithMany()
                        .HasForeignKey("WorkHistoryJobId");
                });
            ...
            modelBuilder.Entity("NewResume.Models.Job", b =>
                {
                    b.HasOne("NewResume.Models.Employer")
                        .WithMany("Jobs")
                        .HasForeignKey("EmployerId");
